...
description: Project management helper for organizing tasks, Kanban states, priorities, blockers, and project status summaries. Use cautiously because the original skill contains environment-specific paths.
---
