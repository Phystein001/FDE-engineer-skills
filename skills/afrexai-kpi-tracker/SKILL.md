...
description: Track, analyze, and report on business KPIs, targets, thresholds, and weekly or monthly metric status. Use when defining KPIs, checking metric health, or generating KPI reports.
---
